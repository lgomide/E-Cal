...
public class EventsActivity extends Activity implements WeekView.MonthChangeListener, WeekView.EventClickListener, WeekView.EventLongPressListener{
    ...
    private final String deviceName = "eCal"; //00:06:66:6B:59:80
    private final String deviceBluetoothId = "00:06:66:6B:59:80";
    ...
    private void uploadBluetooth(){
        ...
        for(BluetoothDevice mDevice : pairedDevices){
            if(mDevice.getAddress().equals(deviceBluetoothId)){
                deviceFound = true;
                device = mDevice;
                break;
            }
        ...
        if(!connected){
            Toast.makeText(EventsActivity.this, "Could not connect to eCal device", Toast.LENGTH_LONG).show();
        }
    }
    ...
    private void uploadWifi(){
        Firebase deviceChild = myFirebaseRef.child("0");
        ...
        AlertDialog dialog = new AlertDialog.Builder(EventsActivity.this)
                ...
                .setPositiveButton("Add", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        Calendar startCal = event.getStartCalendar();
                        Calendar endCal = event.getEndCalendar();

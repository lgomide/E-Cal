...
public class EventsActivity extends Activity implements WeekView.MonthChangeListener, WeekView.EventClickListener, WeekView.EventLongPressListener{
    ...
    public List<WeekViewEvent> onMonthChange(int newYear, int newMonth) {
        ...
        WeekViewEvent event = new WeekViewEvent(1,"1",startTime,endTime);
        ...
        endTime.set(Calendar.MONTH, newMonth-1);
        event = new WeekViewEvent(10, "2", startTime, endTime);
        ...
        event = new WeekViewEvent(10, "3", startTime, endTime);
        ...
        endTime.set(Calendar.MONTH, newMonth-1);
        event = new WeekViewEvent(2, "4", startTime, endTime);
        event.setColor(getResources().getColor(R.color.event_color_02));
        events.add(event);
